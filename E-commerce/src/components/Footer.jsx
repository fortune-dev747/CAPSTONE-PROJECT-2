        ...
        <footer className={styles.footer}>
            <div className={styles.footerContainer}>
                ...
                <div className={styles.footerBrand}>
                    ...
                    <p className={styles.footerTagline}>Premium devices. Unbeatable prices. Delivered fast.</p>
                ...
                <div className={styles.footerContact}>
                    ...
                    <ul>
                        <li>
                            <a href="tel:09122278793" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <li>
                            <a href="mailto:fortuneemmanuel18@gmail.com" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                                </svg>
                                fortuneemmanuel18@gmail.com
                            </a>
                        </li>
